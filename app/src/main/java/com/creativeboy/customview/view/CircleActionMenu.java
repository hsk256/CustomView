...
public class CircleActionMenu extends ViewGroup implements OnClickListener
{
    ...
    public CircleActionMenu(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        int pos = a.getInt(R.styleable.ArcMenu_position1, POS_RIGHT_BOTTOM);
        switch (pos)
        {
            case POS_LEFT_TOP:
